...
bennyGarages = {
    [1] = {coords = vector4(-211.55, -1324.55, 30.90, 319.73135375977), useJob = true, job = {"mechanic"}},
    [2] = {coords = vector4(-1423.86, -450.03, 35.91, 32.35), useJob = true, job = {"mechanic"}},
    [3] = {coords = vector4(109.89, 6627.07, 31.78, 221.7938), useJob = true, job = {"mechanic"}}
}
