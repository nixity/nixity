...
Config.BaseTime         = 20 -- Time                                             default: 8
...
Config.NewWeatherTimer  = 7 -- Time (in minutes) between each weather change   default: 10
Config.Disabled         = true -- Set weather disabled                         default: false
