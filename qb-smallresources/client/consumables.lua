...
AddEventHandler("consumables:client:Eat", function(itemName)
    ...
    QBCore.Functions.Progressbar("eat_something", "Eating..", 2500, false, true, {
        ...
        TriggerServerEvent('hud:server:RelieveStress', math.random(0, 4))
    end)
end)

RegisterNetEvent("consumables:client:food")
AddEventHandler("consumables:client:food", function(itemName)
...
AddEventHandler("consumables:client:Drink", function(itemName)
    ...
    QBCore.Functions.Progressbar("drink_something", "Drinking..", 2600, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
