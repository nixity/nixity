...
Config.ClothingRooms = {
    [1] = {requiredJob = "police", coords = vector3(462.97, -999.16, 30.69), cameraLocation = vector4(462.97, -999.16, 30.69,88.99)},
        ...
        ["male"] = {
            ...
            [3] = {
                ...
                outfitData = {
                    ...
                    ["t-shirt"]     = { item = 38, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 2, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 31, texture = 1},  -- Jas / Vesten
                    ["shoes"]       = { item = 24, texture = 0},  -- Schoenen
                    -- ["decals"]      = { item = 7, texture = 0},  -- Decals
                    ["accessory"]   = { item = 0, texture = 0},  -- Nek / Das
                    ["bag"]         = { item = 0, texture = 0},  -- Tas
            ...
            [6] = {
                ...
                outfitData = {
                    ...
                    ["torso2"]      = { item = 98, texture = 0},  -- Jas / Vesten
                    ["shoes"]       = { item = 24, texture = 0},  -- Schoenen
                    -- ["decals"]      = { item = 7, texture = 0},  -- Decals
                    ["accessory"]   = { item = 0, texture = 0},  -- Nek / Das
            --      ["bag"]         = { item = 0, texture = 0},  -- Tas
                    ["hat"]         = { item = 39, texture = 2},  -- Pet
                    ["glass"]       = { item = 0, texture = 4},  -- Bril
            --      ["ear"]         = { item = 0, texture = 0},  -- Oor accessoires
                    ["mask"]         = { item = 52, texture = 0},  -- Masker
                },
            },
            [7] = {
                outfitLabel = "fbi",
                outfitData = {
                    ["pants"]       = { item = 13, texture = 0},  -- Broek
                    ["arms"]        = { item = 1, texture = 0},  -- Armen
