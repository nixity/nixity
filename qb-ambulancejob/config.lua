...
Config.Locations = {
    ...
    ["duty"] = {
        [1] = vector4(310.6, -597.14, 43.28, 165.2),
        [2] = vector4(-254.88, 6324.5, 32.58, 0.0),
    },    
    ["vehicle"] = {
        [1] = vector4(316.11, -577.96, 28.8, 257.9),
    ...
    ["armory"] = {
        [1] = vector4(306.25, -601.72, 43.28, 155.57),
    ...
    ["beds"] = {
        [1] = {coords = vector4(313.82, -578.92, 44.2, 247.04), taken = false, model = 1631638868},
        [2] = {coords = vector4(363.94, -588.96, 44.21, 162.95), taken = false, model = 1631638868}, 
        [3] = {coords = vector4(319.42, -581.08, 44.2, 347.78), taken = false, model = -1091386327},
    }, 
    ["stations"] = {
